...
public class StreakRecordRepository {
    ...
    public StreakRecordRepository(DynamoDBMapper dynamoDBMapper){
    ...
    public StreakRecord findById(String streakId){
        return dynamoDBMapper.load(StreakRecord.class,streakId);
    }
    public List<StreakRecord> findAll(){
        return dynamoDBMapper.scan(StreakRecord.class,new DynamoDBScanExpression());
    }
