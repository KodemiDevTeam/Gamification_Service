...
public class RewardRuleRepository {
    ...
    public RewardRuleRepository(DynamoDBMapper dynamoDBMapper) { this.dynamoDBMapper = dynamoDBMapper; }
    public RewardRule save(RewardRule rewardRule){
        dynamoDBMapper.save(rewardRule);
        return rewardRule;
    }
    public RewardRule findById(String ruleId) { return dynamoDBMapper.load(RewardRule.class, ruleId); }
    public List<RewardRule> findAll() { return dynamoDBMapper.scan(RewardRule.class, new DynamoDBScanExpression()); }
