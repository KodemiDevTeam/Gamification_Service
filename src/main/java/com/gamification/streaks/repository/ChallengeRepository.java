...
public class ChallengeRepository {
    ...
    public  ChallengeRepository(DynamoDBMapper dynamoDBMapper){
    ...
    public Challenge findById(String challengeId){
        return dynamoDBMapper.load(Challenge.class,challengeId);
    }
    public List<Challenge> findAll(){
        return dynamoDBMapper.scan(Challenge.class,new DynamoDBScanExpression());
    }
